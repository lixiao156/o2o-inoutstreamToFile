 ...
 * 加载spring容器获取实体类
 *
 * @FixMethodOrder(MethodSorters.NAME_ASCENDING) 按照名字顺序执行Junit
 */
...
public class ProductCategoryDaoTest extends BaseTest {
    ...
    public void testBQueryProductCategoryList() {
        ...
        System.out.println("该店铺的自定义类别的数为" + productCategoryList.size());
    }
    ...
    public void testCDeleteProductCategory() {
        ...
        for (ProductCategory pc : productCategoryList) {
            if ("商品类别1".equals(pc.getProductCategoryName()) || "烟酒".equals(pc.getProductCategoryName())) {
